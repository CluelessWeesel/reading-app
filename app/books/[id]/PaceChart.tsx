  ...
  return (
    <div className="space-y-4">
      {metrics.map((m) => {
        ...
        return (
          <div key={m.label}>
            <p className="mb-1.5 text-xs font-medium uppercase tracking-wide text-ink-faint">{m.label}</p>
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="w-10 shrink-0 text-xs text-ink-faint">You</span>
                ...
                <span className="w-16 shrink-0 text-right text-xs tabular-nums text-ink">
                  {m.mine.toFixed(m.digits)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-10 shrink-0 text-xs text-ink-faint">Usual</span>
                <div className="h-2.5 flex-1 overflow-hidden rounded-full bg-hairline">
                  <div
