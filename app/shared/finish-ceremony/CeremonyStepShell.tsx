  ...
  return (
    <div className="mx-auto flex min-h-0 w-full max-w-lg flex-1 flex-col px-4 py-6 sm:py-10">
      <div className="mb-6 shrink-0">
        ...
        <h2 className={`${fraunces.className} text-2xl font-semibold text-ink`}>{title}</h2>
      </div>
      ...
      <div className="mt-6 flex shrink-0 items-center justify-between gap-4 border-t border-hairline pt-4">
