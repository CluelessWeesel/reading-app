...
export type StoryListRow = { id: number; story_type: StoryType; period: string; generated_at: string; card_count: number };
...
export function StoriesSection({ stories }: { stories: StoryListRow[] }) {
  return (
