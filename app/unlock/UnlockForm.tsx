  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-paper px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-xs text-center">
        <h1 className={`${fraunces.className} mb-6 text-2xl font-semibold text-ink`}>
          Enter passcode
        </h1>
        <input
          type="password"
          ...
          className="w-full rounded-lg border border-hairline bg-card/70 px-4 py-3 text-center text-2xl tracking-[0.5em] text-ink shadow-sm outline-none transition focus:ring-2 focus:ring-accent/40"
        />
